...
export const fillDef = (tag = "span", data: string) => fill(tag, data, tag);
export const fillAlt = (key = "key", val = "val") =>
  " " + key + '="' + val + '"';

export const fillSpace = (tag = "span", cls = "", sty = "") =>
  fill(tag, "&nbsp", cls, sty);
...
export const codeStart = (
  ...
  ">";
export const codeEnd = (tag1 = "pre", tag2 = "code") =>
  "</" + tag2 + "></" + tag1 + ">";
